...
function scars_enqueue_scripts()
{
    ...
    wp_enqueue_style('scars-splide', get_template_directory_uri() . '/assets/splide/css/splide.min.css', NULL, '1.0.1', 'all');
    wp_enqueue_style('scars-splide-theme', get_template_directory_uri() . '/assets/splide/css/themes/splide-default.min.css', NULL, '1.0.1', 'all');
    wp_enqueue_style('scars-style', get_template_directory_uri() . '/styles/app.css', array('scars-fonts', 'scars-bootstrap', 'scars-splide', 'scars-splide-theme'), '1.0.1', 'all');

    //Enqueuing Scripts
    wp_enqueue_script('scars-bootstrap', get_template_directory_uri() . '/assets/bootstrap/js/bootstrap.bundle.min.js', NULL, '1.0.1', true);
    wp_enqueue_script('scars-splide', get_template_directory_uri() . '/assets/splide/js/splide.min.js', NULL, '1.0.1', true);
    wp_enqueue_script('scars-js', get_template_directory_uri() . '/scripts/app.js', array('jquery', 'scars-bootstrap', 'scars-splide'), '1.0.1', true);
}
